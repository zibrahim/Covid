...
clustering.data = cbind(patient.data$Age, patient.data$Gender, patient.data$NumComorbidities, patient.data$SymptomsToAdmission)

#colnames(clustering.data) = c("Age","Gender","Ethnicity", "COPD", "Asthma", "HF","Diabetes","IHD","HTN","CKD")
colnames(clustering.data) = c("Age", "Gender", "Comorbidities", "Sympt to Admiss")
...
################################4. Plot clustering performance metrics
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/trainingQualityNotOld.pdf")
    plot(knox.som, type="changes", main="Training Progress")
    dev.off()

    ##plot the count of samples mapping to each cluster.
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/DemographicsNotOld/nodeCountNotOld.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/neighbourDistanceNotOld.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/qualityNotOld.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/nodesNotOld.pdf")
...
################################From: https://rpubs.com/erblast/SOM
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/optimalNoOfClustersElbowNotOld.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/optimalNoOfClustersSilhouetteNotOld.pdf")
    factoextra::fviz_nbclust(dist_adj
                     , factoextra::hcut
                     , method = "silhouette"
                     , hc_method = "ward.D2"
   ...
   # final.number.of.clusters  = 6
    ...
    #plot votes
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/VotesOnNoOfClustersNotOld.pdf")
    df_clust_success %>%
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/ClustersNotOld.pdf")
...
# get vector with cluster value for each original data sample
    ...
    save.image(file="/Users/babylon/Documents/Data/KCHData/ClusteringData/SOMClusteringDemographicsNotOld.RData")
    write.csv(patient.data, file = "/Users/babylon/Documents/Data/KCHData/ClusteringData/ClusteredDataDemographicsNotOld.csv")
