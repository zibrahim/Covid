...
rm(list=ls())
load(file="/Users/babylon/Documents/Data/KCHData/ClusteringData/SOMClusteringDemographicsNotOld.RData")
...
pdf("/Users/babylon/Documents/Covid/Figures/Clustering/DemographicsNotOld/AllFeaturesNotOld.pdf")
