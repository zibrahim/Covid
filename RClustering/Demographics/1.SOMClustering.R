...
################################4. Plot clustering performance metrics
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/trainingQuality.pdf")
    plot(knox.som, type="changes", main="Training Progress")
    dev.off()

    ##plot the count of samples mapping to each cluster.
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/Demographics/nodeCount.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/neighbourDistance.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/quality.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/nodes.pdf")
...
################################From: https://rpubs.com/erblast/SOM
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/optimalNoOfClustersElbow.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/optimalNoOfClustersSilhouette.pdf")
    factoextra::fviz_nbclust(dist_adj
                     , factoextra::hcut
                     , method = "silhouette"
                     , hc_method = "ward.D2"
   ...
   # final.number.of.clusters  = 6
    ...
    #plot votes
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/VotesOnNoOfClusters.pdf")
    df_clust_success %>%
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/Clusters.pdf")
...
# get vector with cluster value for each original data sample
    ...
    save.image(file="/Users/babylon/Documents/Data/KCHData/ClusteringData/SOMClusteringDemographics.RData")
    write.csv(patient.data, file = "/Users/babylon/Documents/Data/KCHData/ClusteringData/ClusteredDataDemographics.csv")
