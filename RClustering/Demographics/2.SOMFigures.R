...
rm(list=ls())
load(file="/Users/babylon/Documents/Data/KCHData/ClusteringData/SOMClusteringDemographics.RData")
...
pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Demographics/AllFeatures.pdf")
