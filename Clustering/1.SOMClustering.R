...
################################4. Plot clustering performance metrics
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/trainingQuality.pdf")
    plot(knox.som, type="changes", main="Training Progress")
    dev.off()

    ##plot the count of samples mapping to each cluster.
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/nodeCount.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/neighbourDistance.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/quality.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/nodes.pdf")
...
################################From: https://rpubs.com/erblast/SOM
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/optimalNoOfClustersElbow.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/optimalNoOfClustersSilhouette.pdf")
    factoextra::fviz_nbclust(dist_adj
                     , factoextra::hcut
                     , method = "silhouette"
                     , hc_method = "ward.D2"
   ...
   # final.number.of.clusters  = 6
    ...
    #plot votes
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/VotesOnNoOfClusters.pdf")
    df_clust_success %>%
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/Clustering/Clusters.pdf")
...
# get vector with cluster value for each original data sample
    ...
    save.image(file="/Users/babylon/Documents/Covid/Data/SOMClustering.RData")
