...
################################1. Read data file
patient.data = read.csv(file='/Users/babylon/Documents/Covid/Data/Patients.csv')
...
patient.data<-patient.data[patient.data$Age<= 70 ,]
...
clustering.data = cbind(patient.data$Age, patient.data$Gender,patient.data$Ethnicity,patient.data$NumComorbidities, patient.data$SymptomsToAdmission )

colnames(clustering.data) = c("Age","Gender","Ethnicity", "NumComorbidities","SxToAdmit")
...
################################4. Plot clustering performance metrics
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/trainingQuality.pdf")
    plot(knox.som, type="changes", main="Training Progress")
    dev.off()

    ##plot the count of samples mapping to each cluster.
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/nodeCount.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/neighbourDistance.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/quality.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/nodes.pdf")
...
################################From: https://rpubs.com/erblast/SOM
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/optimalNoOfClustersElbow.pdf")
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/optimalNoOfClustersSilhouette.pdf")
    factoextra::fviz_nbclust(dist_adj
                     , factoextra::hcut
                     , method = "silhouette"
                     , hc_method = "ward.D2"
   ...
   # final.number.of.clusters  = 6
    ...
    #plot votes
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/VotesOnNoOfClusters.pdf")
    df_clust_success %>%
    ...
    pdf("/Users/babylon/Documents/Covid/Figures/ClusteringNotOld/ClustersNotOld.pdf")
...
# get vector with cluster value for each original data sample
    ...
    save.image(file="/Users/babylon/Documents/Covid/Data/SOMClusteringNotOldSxAdmit0.RData")


write.csv(patient.data,'/Users/babylon/Documents/Covid/Data/PatientsNotOld.csv')
